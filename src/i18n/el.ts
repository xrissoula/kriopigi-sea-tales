...
export const el: Record<string, string> = {
  ...
  "Kriopigi — \"cold spring\" — sits on the eastern Kassandra coast, on the Toronean Gulf, a crescent of fine sand under Aleppo pines, looking out over what Homer called the oînops póntos, the wine-dark sea. This guide gathers what locals, scientists, and travelers have learned of its tides, meadows, and migrants.":
    "Η Κρυοπηγή — από την «κρύα πηγή» που της έδωσε το όνομά της — απλώνεται στην ανατολική ακτή της Κασσάνδρας, στον κόλπο του Τορωναίου, μια ημισέληνος από ψιλή άμμο κάτω από χαλέπια πεύκα, με θέα σε αυτό που ο Όμηρος αποκάλεσε οἶνοπα πόντον, τη σκοτεινή σαν κρασί θάλασσα. Αυτός ο οδηγός συγκεντρώνει όσα έχουν μάθει οι κάτοικοι, οι επιστήμονες και οι ταξιδιώτες για τις παλίρροιες, τα λιβάδια και τους εποχικούς επισκέπτες της.",
