...
export const elBiogeochemistry: Record<string, string> = {
  ...
  "A subducting plate beneath the sea": "Μια τεκτονική πλάκα που καταβυθίζεται κάτω από τη θάλασσα",
  "The Aegean sits above the Hellenic Subduction System, where the African plate dives beneath Eurasia along a curved trench south of Crete. This slow convergence drives the tectonic evolution of the region, creating the basins, volcanic arc, and seafloor topography that in turn influence circulation and the chemistry of the water column.":
    "Το Αιγαίο βρίσκεται πάνω από το Ελληνικό Σύστημα Καταβύθισης, όπου η αφρικανική λιθοσφαιρική πλάκα βυθίζεται κάτω από την ευρασιατική κατά μήκος της καμπύλης τάφρου νότια της Κρήτης. Αυτή η αργή σύγκλιση οδηγεί την τεκτονική εξέλιξη της περιοχής, δημιουργώντας τις λεκάνες, το ηφαιστειακό τόξο και την υποβρύχια τοπογραφία που με τη σειρά τους επηρεάζουν την κυκλοφορία και τη χημεία της υδάτινης στήλης.",
  ...
  "Back-arc extension": "Εφελκυσμός του οπισθοτόξου",
  ...
  "Behind the arc, the Aegean crust pulls apart. The North Aegean and Skyros basins open as tectonic graben, while the volcanic arc — Methana, Milos, Santorini, Nisyros — punches through the thinned crust. This extensional architecture largely determines the depth and geometry of the basins that guide modern water circulation.":
    "Πίσω από το Ελληνικό Τόξο, ο φλοιός του Αιγαίου διατείνεται και λεπταίνει. Οι λεκάνες του Βόρειου Αιγαίου και της Σκύρου σχηματίζονται ως τεκτονικές τάφροι (graben), ενώ το ηφαιστειακό τόξο — Μέθανα, Μήλος, Σαντορίνη και Νίσυρος — διαπερνά τον λεπτυσμένο φλοιό. Αυτή η εκτατική δομή καθορίζει σε μεγάλο βαθμό το βάθος και τη γεωμετρία των λεκανών που κατευθύνουν τη σύγχρονη κυκλοφορία των νερών.",
  ...
  "The basins water settles into": "Οι λεκάνες όπου συγκεντρώνεται το νερό",
  ...
  "How water moves through the Aegean": "Πώς κινούνται τα νερά του Αιγαίου",
  "Cool, fresher Black Sea water enters from the Dardanelles and sweeps west and south along the Greek coast; warmer, saltier Levantine water pushes north along the Turkish side. The interaction between fresher Black Sea water and warmer, saltier Levantine water helps shape seasonal fronts, mixing, and circulation around Halkidiki, flushing coastal bays and influencing the distribution of nutrients.":
    "Τα ψυχρότερα και λιγότερο αλμυρά νερά της Μαύρης Θάλασσας εισέρχονται από τα Δαρδανέλλια και κινούνται προς τα δυτικά και νότια κατά μήκος των ελληνικών ακτών, ενώ τα θερμότερα και πιο αλμυρά νερά της Λεβαντίνης ανέρχονται προς τον βορρά κατά μήκος των τουρκικών παραλίων. Η αλληλεπίδραση μεταξύ του λιγότερο αλμυρού νερού της Μαύρης Θάλασσας και του θερμότερου, πιο αλμυρού νερού της Λεβαντίνης συμβάλλει στη διαμόρφωση εποχιακών μετώπων, ανάμειξης και κυκλοφορίας γύρω από τη Χαλκιδική, ανανεώνοντας τα παράκτια κόλπους και επηρεάζοντας την κατανομή των θρεπτικών στοιχείων.",
  ...
  "Water exchanged through the Cretan Straits links the Aegean to the wider Eastern Mediterranean. These exchanges contribute to the formation and transformation of intermediate and deep water masses, including Levantine Intermediate Water, which plays a major role in ventilating the eastern Mediterranean. The Rhodes Gyre, farther to the southeast, is one of the basin's principal sites of winter deep-water formation and oxygenation. The chemistry of the water at Kriopigi is one node within this much larger circulation.":
    "Το νερό που ανταλλάσσεται μέσω των στενών της Κρήτης συνδέει το Αιγαίο με την ευρύτερη Ανατολική Μεσόγειο. Αυτές οι ανταλλαγές συμβάλλουν στη δημιουργία και στον μετασχηματισμό των ενδιάμεσων και βαθιών υδάτινων μαζών, συμπεριλαμβανομένου του Ενδιάμεσου Νερού της Λεβαντίνης (Levantine Intermediate Water), το οποίο διαδραματίζει σημαντικό ρόλο στον αερισμό της ανατολικής Μεσογείου. Ο στρόβιλος της Ρόδου, πιο νοτιοανατολικά, είναι ένα από τα κύρια σημεία βαθιάς χειμερινής σχηματισμού νερού και οξυγόνωσης της λεκάνης. Η χημεία του νερού στην Κρυοπηγή αποτελεί έναν μικρό κρίκο αυτού του πολύ ευρύτερου συστήματος κυκλοφορίας.",
