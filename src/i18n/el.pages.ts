...
export const elPages: Record<string, string> = {
  ...
  "In an enclosed, oligotrophic system like parts of the Aegean, even moderate nutrient inputs can shift nearshore ecology: algal growth, turbidity, seagrass stress, altered nutrient balance, coastal erosion, bacterial contamination, and local biodiversity changes.":
    "Σε ένα κλειστό, ολιγοτροφικό σύστημα όπως τμήματα του Αιγαίου, ακόμη και μέτριες εισροές θρεπτικών μπορούν να μεταβάλουν την παράκτια οικολογία: ανάπτυξη φυκών, θολερότητα, καταπόνηση της ποσειδωνίας, αλλαγή στην ισορροπία θρεπτικών, παράκτια διάβρωση, βακτηριακή μόλυνση και τοπικές αλλαγές στη βιοποικιλότητα.",
  ...
  "The fibrous brown mats piled at the high-tide line are not rubbish. They are banquettes: dead Posidonia leaves woven by waves into dense berms that absorb storm energy and shield the sand behind them from erosion. The small felted balls scattered around them — egagropiles — are rolled fragments of the same leaf fibre. Bulldozing banquettes off the beach for tourist comfort is one of the single largest causes of shoreline retreat on Mediterranean coasts.":
    "Οι ινώδεις καφέ στρώσεις στη γραμμή της παλίρροιας δεν είναι σκουπίδια. Είναι οι μπανκέτες: νεκρά φύλλα ποσειδωνίας που τα κύματα πλέκουν σε πυκνά αναχώματα τα οποία απορροφούν την ενέργεια των καταιγίδων και προστατεύουν την άμμο πίσω τους από τη διάβρωση. Οι μικρές τσόχινες μπάλες γύρω τους — τα εγαγρόπιλα — είναι κυλισμένα θραύσματα της ίδιας φυτικής ίνας. Η απομάκρυνση των μπανκετών με μπουλντόζες για την άνεση των τουριστών είναι μία από τις μεγαλύτερες αιτίες υποχώρησης της ακτογραμμής στη Μεσόγειο.",
  ...
  "Just offshore, where the sand meets the first underwater slope, you can often see the brown terraced edge of a dead matte — the compacted root-and-rhizome scaffolding left behind by past meadows. These mattes can be thousands of years old and continue to stabilise sediment long after the living plant is gone. Ripple marks in the shallow sand show how much water energy this zone is constantly absorbing.":
    "Λίγο πιο έξω, εκεί που η άμμος συναντά την πρώτη υποθαλάσσια κλίση, συχνά διακρίνεται η καφετιά αναβαθμιδωτή άκρη μιας νεκρής μάτας — του συμπαγούς πλέγματος ριζών και ριζωμάτων που άφησαν παλιότερα λιβάδια. Αυτές οι μάτες μπορεί να είναι χιλιάδων ετών και συνεχίζουν να σταθεροποιούν το ίζημα πολύ αφότου το ζωντανό φυτό έχει χαθεί. Οι κυματισμοί στη ρηχή άμμο δείχνουν πόση ενέργεια νερού απορροφά διαρκώς αυτή η ζώνη.",
  ...
  "— a global citizen-science platform where your geotagged photos are identified by experts and pooled into open biodiversity data used by researchers worldwide.":
    "— μια παγκόσμια πλατφόρμα επιστήμης των πολιτών, όπου οι γεωσημασμένες φωτογραφίες σας ταυτοποιούνται από ειδικούς και συγκεντρώνονται σε ανοιχτά δεδομένα βιοποικιλότητας που χρησιμοποιούν ερευνητές παγκοσμίως.",
};
