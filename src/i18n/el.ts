...
export const el: Record<string, string> = {
  ...
  "Posidonia meadows & how to tread lightly.":
    "Λιβάδια ποσειδωνίας και πώς να πατάμε ελαφρά.",
  Section: "Ενότητα",
