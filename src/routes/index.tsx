    ...
    <SiteLayout>
      ...
      <section className="px-5 py-16 max-w-2xl mx-auto text-center">
        ...
        <p className="mt-4 text-muted-foreground leading-relaxed">
          {t("Kriopigi — \"cold spring\" — sits on the western Kassandra coast, a crescent of fine sand under Aleppo pines, looking out over what Homer called the")} <em>oînops póntos</em>, {t("the wine-dark sea. This guide gathers what locals, scientists, and travelers have learned of its tides, meadows, and migrants.")}
        </p>
      </section>
