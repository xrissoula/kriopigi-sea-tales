...
export const elAnthropology: Record<string, string> = {
  ...
  // --- Timeline ---
  "~6500 BCE": "~6500 π.Χ.",
  "First settlers": "Οι πρώτοι κάτοικοι",
  "Neolithic communities arrive in Halkidiki, drawn to springs, sheltered coves, and the rich Thermaic Gulf. Stone tools and ceramics from this period are found across the Kassandra peninsula.":
    "Νεολιθικές κοινότητες εγκαθίστανται στη Χαλκιδική, προσελκυόμενες από τις πηγές, τους προστατευμένους όρμους και τον πλούσιο Θερμαϊκό Κόλπο. Λίθινα εργαλεία και κεραμικά αυτής της περιόδου έχουν βρεθεί σε ολόκληρη τη χερσόνησο της Κασσάνδρας.",
  ...
  "General plan of the southern projection of the Megali Toumba at Olynthus. From G. E. Mylonas, Excavations at Olynthus, Part I: The Neolithic Settlement (Johns Hopkins University Studies in Archaeology No. 6, ed. D. M. Robinson; Baltimore: The Johns Hopkins Press / London: Humphrey Milford / Oxford University Press, 1929).":
    "Γενική κάτοψη της νότιας προέκτασης της Μεγάλης Τούμπας στην Όλυνθο. Από τον G. E. Mylonas, Excavations at Olynthus, Part I: The Neolithic Settlement (1929).",

  "~700 BCE": "~700 π.Χ.",
  "Ancient Mende & Eretrian colonies": "Η αρχαία Μένδη και οι αποικίες της Ερέτριας",
  ...
  "Philip II of Macedon destroys Olynthos and consolidates Halkidiki under Macedonian control. The region's harbours feed Alexander's campaigns.":
    "Ο Φίλιππος Β΄ της Μακεδονίας καταστρέφει την Όλυνθο και ενοποιεί τη Χαλκιδική υπό μακεδονικό έλεγχο. Τα λιμάνια της περιοχής στηρίζουν αργότερα τις εκστρατείες του Μεγάλου Αλεξάνδρου.",
  ...
  "Mount Athos to the east becomes the spiritual heart of Orthodoxy. Kassandra's villages live by fishing, olives, and beekeeping; the cold spring at Kriopigi serves caravans crossing the peninsula.":
    "Το Άγιο Όρος, στα ανατολικά, εξελίσσεται στο πνευματικό κέντρο της Ορθοδοξίας. Τα χωριά της Κασσάνδρας ζουν από την αλιεία, την ελαιοκαλλιέργεια και τη μελισσοκομία, ενώ η κρύα πηγή της Κρυοπηγής εξυπηρετεί τους ταξιδιώτες που διασχίζουν τη χερσόνησο.",
  ...
  "Revolution & rebuilding": "Επανάσταση και αναγέννηση",
  "Kassandra rises in the Greek War of Independence and is devastated in 1821. Villages are slowly resettled through the 19th century by refugees and returning families.":
    "Η Κασσάνδρα συμμετέχει ενεργά στην Ελληνική Επανάσταση και καταστρέφεται ολοσχερώς το 1821. Κατά τη διάρκεια του 19ου αιώνα τα χωριά εποικίζονται ξανά σταδιακά από πρόσφυγες και οικογένειες που επιστρέφουν στην περιοχή.",
  ...
  "Following the Greco–Turkish war, refugees from Asia Minor settle across Halkidiki, reshaping the demographics, cuisine, and music of the coast.":
    "Μετά τον Ελληνοτουρκικό Πόλεμο και την υποχρεωτική ανταλλαγή των πληθυσμών, πρόσφυγες από τη Μικρά Ασία εγκαθίστανται σε ολόκληρη τη Χαλκιδική, αλλάζοντας τη δημογραφία, την κουζίνα και τη μουσική παράδοση της περιοχής.",
  ...
  "Paved roads reach Kassandra; Kriopigi grows from a fishing hamlet into a summer destination. Pine-shaded campsites and small hotels replace tobacco fields, while the shoreline absorbs new pressures.":
    "Οι ασφαλτοστρωμένοι δρόμοι φτάνουν στην Κασσάνδρα και η Κρυοπηγή μεταμορφώνεται από ένα μικρό ψαροχώρι σε δημοφιλή καλοκαιρινό προορισμό. Κάμπινγκ κάτω από τα πεύκα και μικρά ξενοδοχεία παίρνουν τη θέση των καπνοχώραφων, ενώ η ακτογραμμή καλείται να αντέξει νέες πιέσεις από την ανθρώπινη δραστηριότητα.",
