...
export const elFlora: Record<string, string> = {
  ...
  "Walk from the pine forest above Kriopigi to the open Mediterranean and, within a few hundred metres, the landscape changes repeatedly. Forest becomes shrubland, shrubland gives way to rocky and sandy shore, and beneath the surface entirely different biological communities take over. This page follows that journey from land to sea.":
    "Περπατήστε από το πευκοδάσος πάνω από την Κρυοπηγή έως το ανοιχτό πέλαγος και, μέσα σε λίγες εκατοντάδες μέτρα, το τοπίο αλλάζει συνεχώς. Το δάσος γίνεται θαμνώνας, ο θαμνώνας παραχωρεί τη θέση του σε βραχώδη και αμμώδη ακτή, ενώ κάτω από την επιφάνεια αναπτύσσονται εντελώς διαφορετικές βιολογικές κοινότητες. Αυτή η σελίδα ακολουθεί το ταξίδι από τη στεριά στη θάλασσα.",
  ...
  "Kriopigi sits at the edge of a small but unusually diverse coastal landscape. In a few hundred metres, the land rises from the shore through Aleppo pine forest, maquis shrubland, and sun-baked phrygana, while the sea offers rocky ledges, sandy pockets, and beds of Posidonia oceanica. This mosaic exists because the area combines a Mediterranean climate, limestone geology, varied topography, freshwater runoff, and thousands of years of human land use. The result is an unusually high number of habitats packed into a very small area, and with them, a wide range of species.":
    "Η Κρυοπηγή βρίσκεται στα όρια ενός μικρού αλλά ασυνήθιστα ποικίλου παράκτιου τοπίου. Μέσα σε λίγες εκατοντάδες μέτρα, η γη ανεβαίνει από την ακτή προς το πευκοδάσος, τον μακί, τα ηλιοκαμένα φρύγανα, ενώ η θάλασσα προσφέρει βραχώδεις εξάρσεις, αμμώδεις κόλπους και λιβάδια Ποσειδωνίας (Posidonia oceanica). Αυτό το μωσαϊκό προκύπτει από το συνδυασμό μεσογειακού κλίματος, ασβεστολιθικής γεωλογίας, ποικίλου ανάγλυφου, γλυκού νερού που εκφορτίζεται και χιλιάδων χρόνων ανθρώπινης χρήσης. Το αποτέλεσμα είναι ασυνήθιστα πολλοί βιότοποι συγκεντρωμένοι σε πολύ μικρή έκταση, και μαζί τους, μια μεγάλη ποικιλία ειδών.",
  ...
  "The slopes above Kriopigi are dominated by Aleppo pine (Pinus halepensis), one of the defining trees of the eastern Mediterranean. In places it mixes with Turkish pine (Pinus brutia), forming an open, fire-adapted forest well suited to dry limestone soils.":
    "Οι πλαγιές πάνω από την Κρυοπηγή κυριαρχούνται από τη χαλέπιο πεύκη (Pinus halepensis), ένα από τα χαρακτηριστικά δέντρα της ανατολικής Μεσογείου. Κατά τόπους αναμειγνύεται με την τραχεία πεύκη (Pinus brutia), σχηματίζοντας ένα ανοιχτό, προσαρμοσμένο στη φωτιά δάσος που ταιριάζει σε ξηρά ασβεστολιθικά εδάφη.",
  ...
  "Beneath the pines grows dense evergreen maquis — a tangle of kermes oak, lentisk, strawberry tree, wild olive, myrtle, rosemary, sage and thyme. These aromatic shrubs form one of the characteristic ecosystems of the Mediterranean Basin and provide shelter and food for countless insects, reptiles and birds.":
    "Κάτω από τα πεύκα αναπτύσσεται πυκνός αειθαλής μακί — ένας μπερδεμένος ιστός από πουρνάρια, σχίνους, κουμαριές, αγριελιές, μυρτιές, δεντρολίβανο, φασκόμηλο και θυμάρι. Αυτοί οι αρωματικοί θάμνοι αποτελούν ένα από τα πιο χαρακτηριστικά οικοσυστήματα της λεκάνης της Μεσογείου και προσφέρουν καταφύγιο και τροφή σε αμέτρητα έντομα, ερπετά και πτηνά.",
  ...
  "Rocky ledges, tide pools and small pocket beaches create dozens of microhabitats. Crevices provide shelter from waves and predators, while algae, encrusting organisms and accumulated wrack support diverse communities of molluscs, crustaceans, fishes and other marine life.":
    "Βραχώδεις εξάρσεις, φυσικές λεκάνες και μικροί κόλποι αμμου δημιουργούν δεκάδες μικροενδιαιτήματα. Οι σχισμές προσφέρουν προστασία από τα κύματα και τους θηρευτές, ενώ τα φύκια, οι επικαθισμένοι οργανισμοί και τα σωρευμένα ξεβρασμένα φύκια στηρίζουν ποικίλες κοινότητες μαλακίων, καρκινοειδών, ψαριών και άλλων θαλάσσιων οργανισμών.",
